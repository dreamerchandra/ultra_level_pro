...
const headerStyle = TextStyle(fontSize: 16, fontWeight: FontWeight.w900);

const bodyStyle = TextStyle(fontSize: 16, fontWeight: FontWeight.w900);
...
class TankDetailsWidget extends ConsumerStatefulWidget {
  const TankDetailsWidget({
    ...
    required this.onChangeNonLinearTankLength,
  });
  ...
  final Future<bool> Function(NonLinearBleWriter changer, int length)
  onChangeNonLinearTankLength;
            ...
            Table(
              ...
              children: [
                ...
                if (widget.state?.tankType != TankType.nonLinear) ...[
                    ...
                    children: [
                      ...
                      formItem(
                        Input(
                          hintText: "5",
                          onDone: (parameter, value) {
                            return widget.onDone(parameter, value);
                          },
                  ...
                  if (shouldApply(
                    WriteParameter.TankHeight,
                    widget.state?.tankType,
                  )) ...[
                    tableGap(),
                    TableRow(
                      children: [
            ...
            if (widget.state?.tankType == TankType.nonLinear) ...[
                ...
                children: [
                  ...
                  Expanded(
                    child: Input(
                      ...
                      onDone: (param, val) {
                        return widget.onChangeNonLinearTankLength(
                          changer,
                          int.parse(val),
                        );
                      },
              ...
              if (nonLinearEdit) ...[
                ...
                NonLinearTankDetailsWidget(
                  ...
                  onChange: (val) async {
                    NonLinearBleWriter changer = NonLinearBleWriter(
                      ble: widget.ble,
                    );
                    changer.update(val);
