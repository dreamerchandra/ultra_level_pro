...
const bodyStyle = TextStyle(fontSize: 14, fontWeight: FontWeight.w900);
            ...
            return SingleNonLinearTankDetailsWidget(
              ...
              onRemove: (index) async {
                if (widget.state?.nonLinearParameters != null) {
                  List<NonLinearParameter> newState = List.from(
                    widget.state!.nonLinearParameters,
                  )..removeAt(index);
              ...
              onHeightChange: (index, height) async {
                if (height.isEmpty) return Future.value(false);
                final res =
                    widget.state?.nonLinearParameters.mapIndexed((
                      idx,
                      element,
                    ) {
                      if (idx == index) {
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          const Text('mm:', style: bodyStyle),
                          const SizedBox(width: 8),
                          Text(height.toString(), style: bodyStyle),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Input(
                      ...
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          const Text('ltr:', style: bodyStyle),
                          const SizedBox(width: 16),
                          Text(filled.toString(), style: bodyStyle),
